$(document).ready(() => {
    ...
    fetch(
      ...
      .then(function (data) {
        ...
        $.each(data, (index, value) => {
          ...
          var rows = `
          <div class="wrapper">
          <button class="btn btn-primary" id="download" onclick="Download_schedule(this)"><i class="fa fa-download"></i> Download</button>
          <button class="btn btn-secondary" id="email" onclick="Email_schedule(this)"><i class="fa fa-envelope"></i> Email</button></div>`;
  ...
  var dataTableColumnDefinitions = [
    { targets: 0, data: emi, sortable: true },
    { targets: 1, data: Interest, sortable: true },
    { targets: 2, data: Principal, sortable: true },
    { targets: 3, data: Balance, sortable: true },
  ];
  ...
  var dataTableOptions = {
    ...
    ajax: {
      url: 'http://localhost:8000/api/loan_details/fetch_calculation',
      type: 'POST',
  ...
  var testDataTable = $('#BankA').DataTable(dataTableOptions);
});
